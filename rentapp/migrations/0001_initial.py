    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='static/me.jpg', null=True, upload_to='static/owner-images/', verbose_name='image')),
                ('address', models.CharField(max_length=255)),
                ('owner', models.OneToOneField(max_length=35, on_delete=django.db.models.deletion.CASCADE, related_name='owner', to=settings.AUTH_USER_MODEL, verbose_name='owner name')),
            ],
        ),
        migrations.CreateModel(
            name='Tenant',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='static/me.jpg', null=True, upload_to='static/tenant-images/', verbose_name='photo')),
                ('balance', models.CharField(max_length=11)),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rentapp.owner')),
                ('tenant', models.OneToOneField(max_length=35, on_delete=django.db.models.deletion.CASCADE, related_name='tenant', to=settings.AUTH_USER_MODEL, verbose_name='tenant name')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='rentapp.owner', verbose_name='owner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='document', to='rentapp.tenant')),
            ],
        ),
        migrations.CreateModel(
            name='Deposit',
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deposit', to='rentapp.owner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='complaint', to='rentapp.owner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='agreement', to='rentapp.owner')),
